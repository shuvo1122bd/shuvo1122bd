...
### Aspiring Software Engineer • C++ Developer • Competitive Programmer

Passionate about mastering **Data Structures & Algorithms**, solving challenging problems, and continuously improving my programming skills. Currently focused on building a strong foundation in modern C++ and competitive programming.
...
I'm currently dedicated to strengthening my problem-solving abilities through **C++**, **Data Structures & Algorithms**, and **Competitive Programming**. I enjoy breaking down complex problems into efficient solutions and believe that consistent practice is the key to becoming a better engineer.

My long-term goal is to become a skilled software engineer with a strong algorithmic mindset and the ability to build efficient, scalable software.
...
- [x] Solving Competitive Programming problems daily
- [x] Improving algorithmic thinking
- [x] Exploring the C++ Standard Template Library (STL)
- [x] Learning common problem-solving patterns
...
![Competitive Programming](https://img.shields.io/badge/Competitive%20Programming-FF6F00?style=for-the-badge)
![STL](https://img.shields.io/badge/C++%20STL-00599C?style=for-the-badge)
...
- ⚙️ I love optimizing code for better performance.
- 📚 I enjoy learning new problem-solving techniques.
- 🎯 Every solved problem teaches something new.
